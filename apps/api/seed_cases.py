...
async def seed_cases():
    ...
    async with async_session_maker() as session:
        ...
        # fmt: tuple order:
        # (case_id, pub_id, agency_id, ref_no, title, method, cat,
        #  planned, awarded, award_date, risk, status, geo_scope,
        #  bid_deadline, ntp_date, contract_end_date, procurement_stage)
        cases = [
            # --- 2010 Case (completed) ---
            (
                "c010a9c4-11e2-45e3-a6b1-000000002010", "pub1", DPWH_ID,
                "PHILGEPS-2010-00124", "Construction of Multi-Purpose Hall in Barangay Malate",
                "public_bidding", "infrastructure", 4000000.0, 3950000.0,
                "2010-04-12", 0.05, "completed", "NCR",
                "2010-02-28", "2010-05-01", "2010-12-31", "completed",
            ),
            # --- 2012 Case (completed) ---
            (
                "c012a9c4-11e2-45e3-a6b1-000000002012", "pub1", DPWH_ID,
                "PHILGEPS-2012-00456", "Seawall Construction along Cavite Coastline",
                "public_bidding", "infrastructure", 20000000.0, 19800000.0,
                "2012-08-20", 0.70, "completed", "Region IV-A",
                "2012-06-15", "2012-09-15", "2013-06-30", "completed",
            ),
            # --- 2015 Case (completed) ---
            (
                "c015a9c4-11e2-45e3-a6b1-000000002015", "pub1", DEPED_ID,
                "PHILGEPS-2015-00789", "Procurement of Elementary School Math Textbooks",
                "public_bidding", "goods", 12000000.0, 11900000.0,
                "2015-05-18", 0.25, "completed", "National",
                "2015-03-20", "2015-06-10", "2015-10-31", "completed",
            ),
            # --- 2018 Case (completed) ---
            (
                "c018a9c4-11e2-45e3-a6b1-000000002018", "pub1", DOH_ID,
                "PHILGEPS-2018-01234", "DOH National Immunization Syringes Supply",
                "public_bidding", "goods", 25000000.0, 24800000.0,
                "2018-11-03", 0.70, "completed", "National",
                "2018-09-01", "2018-12-01", "2019-05-31", "completed",
            ),
            # --- 2020 Case (completed) ---
            (
                "c020a9c4-11e2-45e3-a6b1-000000002020", "pub1", DOH_ID,
                "PHILGEPS-2020-00998", "Emergency Procurement of COVID PPEs",
                "negotiated", "goods", 80000000.0, 79500000.0,
                "2020-04-15", 0.95, "completed", "National",
                "2020-03-20", "2020-05-01", "2020-09-30", "completed",
            ),
            # --- 2022 Case (completed) ---
            (
                "c022a9c4-11e2-45e3-a6b1-000000002022", "pub1", DPWH_ID,
                "PHILGEPS-2022-03456", "DPWH NCR Road Maintenance & Drainage Desilting",
                "public_bidding", "infrastructure", 35000000.0, 34500000.0,
                "2022-10-24", 0.70, "completed", "NCR",
                "2022-08-15", "2022-11-15", "2023-05-31", "completed",
            ),
            # --- 2024 Cases ---
            # Awarded & Ongoing (bid deadline passed, award issued, NTP issued, not yet done)
            (
                "d7b3a9c4-11e2-45e3-a6b1-0987654321ab", "pub1", DPWH_ID,
                "PHILGEPS-2024-08821", "Rehabilitation of Manila South Road (KM 12-25)",
                "public_bidding", "infrastructure", 50000000.0, 48500000.0,
                "2024-03-15", 0.78, "open", "Region IV-A",
                "2024-01-20", "2024-04-10", "2025-10-15", "ongoing",
            ),
            # Awarded (bid deadline passed, award issued, NTP not yet)
            (
                "e8c4b0d5-22f3-56f4-b7c2-1098765432bc", "pub1", DPWH_ID,
                "DPWH-NCR-2024-0012", "Construction of Pasig River Bypass Bridge",
                "negotiated", "infrastructure", 100000000.0, 99500000.0,
                "2024-04-02", 0.85, "open", "NCR",
                "2024-02-01", "2024-05-01", "2026-04-01", "awarded",
            ),
            # Completed (bid deadline passed, delivery done)
            (
                "f9d5c1e6-33a4-67a5-c8d3-2109876543cd", "pub1", DEPED_ID,
                "DEPED-2024-TX-0091", "Procurement of Grade 1-3 Elementary Textbooks",
                "public_bidding", "goods", 15000000.0, 14500000.0,
                "2024-02-18", 0.25, "open", "National",
                "2024-01-05", "2024-03-10", "2024-07-31", "completed",
            ),
            # Under evaluation (bid deadline passed 90+ days ago, no award yet)
            (
                "a0e6d2f7-44b5-78b6-d9e4-3210987654de", "pub1", DEPED_ID,
                "DEPED-IVA-2024-IT-0112", "Supply and Delivery of IT Equipment for Calabarzon Schools",
                "shopping", "goods", 10000000.0, 9800000.0,
                "2024-05-10", 0.55, "open", "Region IV-A",
                "2024-03-15", "2024-06-01", "2024-10-31", "under_evaluation",
            ),
            # Ongoing
            (
                "b1f7e3a8-55c6-89c7-e0f5-4321098765ef", "pub1", DOH_ID,
                "DOH-CO-2024-VAC-0042", "Procurement of Specialized Pediatric Vaccines & Syringes",
                "public_bidding", "goods", 30000000.0, 29200000.0,
                "2024-03-29", 0.62, "open", "National",
                "2024-02-01", "2024-04-20", "2025-03-31", "completed",
            ),
            # --- 2025/2026 Cases ---
            # Active bidding (future bid deadline)
            (
                "c025a9c4-11e2-45e3-a6b1-000000000012", "pub1", DPWH_ID,
                "PHILGEPS-2025-01012", "Ilocos Norte Flood Control Wall Desilting & Repair",
                "public_bidding", "infrastructure", 45000000.0, 44200000.0,
                "2025-06-12", 0.68, "completed", "Region I",
                "2025-04-30", "2025-07-01", "2026-01-31", "ongoing",
            ),
            # Completed
            (
                "c025a9c4-11e2-45e3-a6b1-000000000013", "pub1", DPWH_ID,
                "PHILGEPS-2025-01013", "Cagayan Valley Agricultural Bypass Bridge Construction",
                "public_bidding", "infrastructure", 62000000.0, 61500000.0,
                "2025-07-20", 0.72, "completed", "Region II",
                "2025-05-15", "2025-08-15", "2026-08-15", "awarded",
            ),
            # Ongoing
            (
                "c025a9c4-11e2-45e3-a6b1-000000000014", "pub1", DPWH_ID,
                "PHILGEPS-2025-01014", "Central Luzon Expressway Drainage Expansion Project",
                "public_bidding", "infrastructure", 120000000.0, 118500000.0,
                "2025-08-11", 0.81, "completed", "Region III",
                "2025-06-01", "2025-09-01", "2027-03-01", "ongoing",
            ),
            # Awarded
            (
                "c025a9c4-11e2-45e3-a6b1-000000000015", "pub1", DOH_ID,
                "PHILGEPS-2025-01015", "Bicol Regional Hospital ICU Wing Extension Construction",
                "public_bidding", "infrastructure", 85000000.0, 84200000.0,
                "2025-09-02", 0.75, "completed", "Region V",
                "2025-07-01", "2025-10-01", "2027-04-01", "awarded",
            ),
            # Under evaluation (bid deadline passed, no award)
            (
                "c025a9c4-11e2-45e3-a6b1-000000000016", "pub1", DPWH_ID,
                "PHILGEPS-2025-01016", "Western Visayas Bypass Highway Road Rehabilitation",
                "public_bidding", "infrastructure", 95000000.0, 94100000.0,
                "2025-05-18", 0.65, "completed", "Region VI",
                "2025-03-10", None, None, "under_evaluation",
            ),
            # Active bidding (future deadline)
            (
                "c025a9c4-11e2-45e3-a6b1-000000000017", "pub1", DPWH_ID,
                "PHILGEPS-2025-01017", "Central Visayas Waterfront Pier & Wharf Construction",
                "public_bidding", "infrastructure", 150000000.0, 149200000.0,
                "2025-03-24", 0.88, "completed", "Region VII",
                "2026-08-01", None, None, "active_bidding",
            ),
            # Completed
            (
                "c025a9c4-11e2-45e3-a6b1-000000000018", "pub1", DEPED_ID,
                "PHILGEPS-2025-01018", "Eastern Visayas School Building Reconstruction Program",
                "public_bidding", "infrastructure", 18000000.0, 17900000.0,
                "2025-04-14", 0.45, "completed", "Region VIII",
                "2025-02-20", "2025-05-10", "2026-02-10", "ongoing",
            ),
            # Completed
            (
                "c025a9c4-11e2-45e3-a6b1-000000000019", "pub1", DPWH_ID,
                "PHILGEPS-2025-01019", "Davao City Coastal Highway Road Embankment",
                "public_bidding", "infrastructure", 210000000.0, 209500000.0,
                "2025-02-18", 0.83, "completed", "Region XI",
                "2024-12-10", "2025-03-15", "2026-09-15", "ongoing",
            ),
            # Active bidding (future deadline)
            (
                "c025a9c4-11e2-45e3-a6b1-000000000020", "pub1", DEPED_ID,
                "PHILGEPS-2025-01020", "BARMM Regional Administrative Center Digitization Facilities",
                "public_bidding", "goods", 22000000.0, 21800000.0,
                "2025-10-09", 0.35, "completed", "BARMM",
                "2026-08-15", None, None, "active_bidding",
            ),
        ]
        ...
        for (
            ...
            await session.execute(
                ...
                """),
                {
                    ...
                    "status": status,
                    "geo_scope": geo_scope,
                    "bid_deadline": date.fromisoformat(bid_deadline) if bid_deadline else None,
                    "ntp_date": date.fromisoformat(ntp_date) if ntp_date else None,
                    "contract_end_date": date.fromisoformat(contract_end_date) if contract_end_date else None,
